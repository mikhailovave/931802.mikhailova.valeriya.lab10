...
let a = 0;
let glad = document.getElementsByClassName("bunny")[0];
...
topper.addEventListener('mousedown', function () {
    let start = Date.now();
    let bibka = document.getElementsByClassName("switch")[0]
    let timer = setInterval(function () {
        let timePassed = Date.now() - start;
...
topper.addEventListener('click', function () {
    ...
    if (b === 0) {
        ...
        document.getElementsByClassName("bunny")[0].style.display = "block";
